...
/**
 *       \file       htdocs/lezioni/ajax/pagamentoarretrato.php
 *       \brief      File to return Ajax response on pagamentoarretrato list request
 */
...
// Security check
if (!$user->hasRight('lezioni', 'pagamentoarretrato', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax lezioni/ajax/pagamentoarretrato.php");
