...
/**
 * \file    lezioni/core/boxes/lezioniwidget1.php
 * \ingroup lezioni
 * \brief   Widget provided by Lezioni
 *
...
class lezioniwidget1 extends ModeleBoxes
{
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		// Translations
		$langs->loadLangs(array("boxes", "lezioni@lezioni"));
		...
		// $this->hidden = !$user->hasRight('lezioni', 'myobject', 'read');
	}
	...
	public function loadBox($max = 5)
	{
		...
		//dol_include_once("/lezioni/class/lezioni.class.php");

		// Populate the head at runtime
		$text = $langs->trans("LezioniBoxDescription", $max);
		$this->info_box_head = array(
			...
			'subpicto' => 'object_lezioni@lezioni',
