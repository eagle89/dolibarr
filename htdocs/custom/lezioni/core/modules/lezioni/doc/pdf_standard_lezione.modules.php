...
/**
 *  \file       core/modules/lezioni/doc/pdf_standard.modules.php
 *  \ingroup    lezioni
...
/**
 *	Class to manage PDF template standard_lezione
 */
class pdf_standard_lezione extends ModelePDFLezione
{
	/**
	 ...
	 *
	 *  @param		Lezione	$object				Object to generate
	 ...
	 *
	 *  @param	TCPDF		$pdf     		Object PDF
	 *  @param  Lezione	$object     	Object to show
	...
	protected function _pagehead(&$pdf, $object, $showaddress, $outputlangs, $outputlangsbis = null)
	{
		...
		// Show Draft Watermark
		if (getDolGlobalString('LEZIONI_DRAFT_WATERMARK') && $object->statut == $object::STATUS_DRAFT) {
			pdf_watermark($pdf, $outputlangs, $this->page_hauteur, $this->page_largeur, 'mm', dol_escape_htmltag(getDolGlobalString('LEZIONI_DRAFT_WATERMARK')));
		}
