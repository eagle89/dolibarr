...
/**
 *  \file       lezione_agenda.php
 *  \ingroup    lezioni
 *  \brief      Tab of events on Lezione
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Lezione")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Lezione"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_lezione_'.$object->id;
