...
/**
 *  \file       lezione_contact.php
 *  \ingroup    lezioni
 *  \brief      Tab for contacts linked to Lezione
 */
...
$title = $langs->trans("Lezione")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Lezione"), -1, $object->picto);
