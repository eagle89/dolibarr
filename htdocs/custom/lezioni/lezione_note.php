...
/**
 *  \file       lezione_note.php
 *  \ingroup    lezioni
 *  \brief      Tab for notes on Lezione
 */
...
$title = $langs->trans('Lezione').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Lezione"), -1, $object->picto);
