...
/**
 *  \file       pacchetto_agenda.php
 *  \ingroup    lezioni
 *  \brief      Tab of events on Pacchetto
 */
...
if ($object->id > 0) {
	$title = $langs->trans("Pacchetto")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Pacchetto"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_pacchetto_'.$object->id;
