...
/**
 *  \file       pacchetto_contact.php
 *  \ingroup    lezioni
 *  \brief      Tab for contacts linked to Pacchetto
 */
...
$title = $langs->trans("Pacchetto")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Pacchetto"), -1, $object->picto);
