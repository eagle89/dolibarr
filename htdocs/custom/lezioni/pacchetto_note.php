...
/**
 *  \file       pacchetto_note.php
 *  \ingroup    lezioni
 *  \brief      Tab for notes on Pacchetto
 */
...
$title = $langs->trans('Pacchetto').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Pacchetto"), -1, $object->picto);
