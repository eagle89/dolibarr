...
/**
 *  \file       pagamentoarretrato_agenda.php
 *  \ingroup    lezioni
 *  \brief      Tab of events on PagamentoArretrato
 */
...
if ($object->id > 0) {
	$title = $langs->trans("PagamentoArretrato")." - ".$langs->trans('Agenda');
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("PagamentoArretrato"), -1, $object->picto);
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_pagamentoarretrato_'.$object->id;
