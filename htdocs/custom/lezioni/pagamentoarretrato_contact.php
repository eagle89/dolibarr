...
/**
 *  \file       pagamentoarretrato_contact.php
 *  \ingroup    lezioni
 *  \brief      Tab for contacts linked to PagamentoArretrato
 */
...
$title = $langs->trans("PagamentoArretrato")." - ".$langs->trans('ContactsAddresses');
...
if ($object->id) {
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("PagamentoArretrato"), -1, $object->picto);
