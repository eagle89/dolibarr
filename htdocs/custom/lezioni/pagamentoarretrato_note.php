...
/**
 *  \file       pagamentoarretrato_note.php
 *  \ingroup    lezioni
 *  \brief      Tab for notes on PagamentoArretrato
 */
...
$title = $langs->trans('PagamentoArretrato').' - '.$langs->trans("Notes");
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("PagamentoArretrato"), -1, $object->picto);
